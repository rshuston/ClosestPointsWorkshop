...
class DivideAndConquerSolverTests: XCTestCase {
    ...
    func test_findClosestPointsInSimpleRegion_FindsClosestPointsForTwoPointRegion() {
        ...
        let result = subject.findClosestPointsInSimpleRegion(points: points, pointRegion: pointRegion)
    ...
    func test_findClosestPointsInRegion_FindsClosestPointsForAThirteenPointSet() {
        ...
        // 5:                   border
        //
        // 4 calls to findClosestPointsInSimpleRegion()
        // 3 calls to findClosestPointInBorderRegions()

        XCTAssertEqual(subject.recorder.getCallCountFor("findClosestPointsInSimpleRegion"), 4)
        XCTAssertEqual(subject.recorder.getCallCountFor("findClosestPointInBorderRegions"), 3)
    }
    ...
    class SpyDivideAndConquerSolver : DivideAndConquerSolver {
        ...
        internal override func findClosestPointInBorderRegions(points: [Point],
            ...
            recorder.recordCallFor("findClosestPointInBorderRegions", params: [points, lowerRegion, upperRegion, withinAxisDistance])

            let returnValue = super.findClosestPointInBorderRegions(points: points, lowerRegion: lowerRegion, upperRegion: upperRegion, withinAxisDistance: withinAxisDistance)
        ...
        internal override func findClosestPointsInSimpleRegion(points: [Point], pointRegion: PointRegion) -> PointPairAndDistance? {
            recorder.recordCallFor("findClosestPointsInSimpleRegion", params: [points, pointRegion])

            let returnValue = super.findClosestPointsInSimpleRegion(points: points, pointRegion: pointRegion)
